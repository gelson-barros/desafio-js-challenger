...
//myFunction({a: new Date('2000/01/01 08:00:00'), b: new Date('2000/01/01 08:45:00')})//true
//myFunction({a: new Date('2000/01/01 08:45:00'), b: new Date('2000/01/01 08:00:00')})//false
//myFunction({a: new Date('2000/01/01 08:00:00'), b: new Date('2000/01/01 08:00:00')})//false
...
//myFunction({ date: new Date(Date.UTC(2000,01,01)), daysToAdd: 31 })//952041600000
//myFunction({ date: new Date(Date.UTC(2000,01,01)), daysToAdd: 10 })//950227200000
//myFunction({ date: new Date(Date.UTC(2000,02,28,)), daysToAdd: 2 })//954374400000
...
//myFunction(new Date('2000/01/01 09:00:00'), new Date('2000/01/01 08:45:00'))//true
//myFunction(new Date('2000/01/01 08:00:00'), new Date('2000/01/01 09:45:00'))//false
//myFunction(new Date('2000/01/01 08:00:00'), new Date('2000/01/01 09:00:00'))//true
