...
//myFunction({  one: 1,  'prop-2': 2})//2
//myFunction({  'prop-2': 'two',  prop: 'test'})//'two'
...
//myFunction({ continent: 'Asia', country: 'Japan', region: 'Kansai' })//{ continent: 'Asia', region: 'Kansai' }
//myFunction({ country: 'Sweden', continent: 'Europe', planet: 'Earth' })//{ continent: 'Europe', planet: 'Earth' }
//myFunction({ city: 'Sacramento', state: 'California', country: 'USA', continent: 'North America' })//{ city: 'Sacramento', state: 'California', continent: 'North America' }
...
//myFunction({ bear: 'animal', sow: 'female', boar: 'male', cub: 'young' })//{ animal: 'bear', female: 'sow', male: 'boar', young: 'cub' }
//myFunction({ sheep: 'animal', ewe: 'female', ram: 'male', lamb: 'young' })//{ animal: 'sheep', female: 'ewe', male: 'ram', young: 'lamb' }
//myFunction({ Berlin: 'city', Germany: 'country' })//{ city: 'Berlin', country: 'Germany' }
...
//myFunction([{ city: 'Tokyo', country: 'Japan' }, { city: 'Bangkok', country: 'Thailand' }], 'Asia')//[{ city: 'Tokyo', country: 'Japan', continent: 'Asia' }, { city: 'Bangkok', country: 'Thailand', continent: 'Asia' }]
//myFunction([{ city: 'Stockholm', country: 'Sweden' }, { city: 'Paris', country: 'France' }], 'Europe')//[{ city: 'Stockholm', country: 'Sweden', continent: 'Europe' }, { city: 'Paris', country: 'France', continent: 'Europe' }]
...
myFunction({ continent: 'Europe', country: 'Germany' }, { planet: 'Earth', country: 'Munich', state: 'Bavaria' })//{ continent: 'Europe', country: 'Germany', planet: 'Earth', state: 'Bavaria', city: 'Munich'}
myFunction({ continent: 'North America', country: 'USA' }, { planet: 'Earth', country: 'Los Angeles', state: 'California' })//{ continent: 'North America', country: 'USA', planet: 'Earth', state: 'California', city: 'Los Angeles'}
...
//myFunction({fn: 'Lisa', ln: 'Müller', age: 17, size: 175, weight: 67})//{fn: 'Lisa', ln: 'Müller', size: '175cm', weight: '67kg'}
//myFunction({fn: 'Martin', ln: 'Harper', age: 26, email: 'martin.harper@test.de', weight: 102})//{fn: 'Martin', ln: 'Harper', weight: '102kg'}
//myFunction({fn: 'Andrew', ln: 'Harper', age: 81, size: 175, weight: 71})//{fn: 'Andrew', ln: 'Harper', size: '175cm', weight: '71kg'}
//myFunction({fn: 'Matthew', ln: 'Müller', age: 19, email: 'matthew@mueller.de'})//{fn: 'Matthew', ln: 'Müller'}
...
//myFunction({ a: 'a', b: 'b', c: '' })//{ a: 'a', b: 'b', c: null }
//myFunction({ a: '', b: 'b', c: ' ', d: 'd' })//{ a: null, b: 'b', c: null, d: 'd' }
//myFunction({ a: 'a', b: 'b ', c: ' ', d: '' })//{ a: 'a', b: 'b ', c: null, d: null }